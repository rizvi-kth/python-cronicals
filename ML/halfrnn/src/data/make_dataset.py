...
def main(pos_filepath, neg_filepath):
    ...
    pos_array = make_nparray_with_reviews(pos_filepath)
    logger.info('Found positive reviews shape {0!s}' .format(pos_array.shape))
    neg_array = make_nparray_with_reviews(neg_filepath)
    ...
    np.save('train_review_np_array', rev1_array)
    logger.info('All reviews saved to reviews train_review_np_array.npy')
